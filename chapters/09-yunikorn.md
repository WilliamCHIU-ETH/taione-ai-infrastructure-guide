...
![研究、資料更新與分析團隊提出需求，YuniKorn 依佇列政策將共用 CPU、記憶體與 GPU 資源分配給工作](../assets/figures/09-a.png)

*排程器執行團隊制定的政策；「公平」需要先定義配額、權重與優先順序。* [SVG 原圖](../assets/figures/09-a.svg)
...
![逐個啟動時多個作業可能各自等待，成組規劃則先確認一個作業所需的資源組合再執行](../assets/figures/09-b.png)

*成組排程的概念對照；實際規則取決於工作類型與設定。* [SVG 原圖](../assets/figures/09-b.svg)
