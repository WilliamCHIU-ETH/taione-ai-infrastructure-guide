...
<p align="center"><img src="../assets/figures/12-a.png" width="560" alt="應用透過儲存介面存取 Ozone，資料由多台儲存節點共同承載"></p>

*圖 12-1｜資料倉庫可以自己部署。多個入口服務同一個儲存系統；S3 相容介面不表示資料必須放在 AWS。* [SVG 原圖](../assets/figures/12-a.svg)
...
<p align="center"><img src="../assets/figures/12-b.png" width="560" alt="其中一台儲存節點離線，系統的容錯能力取決於保護方式與設定"></p>

*圖 12-2｜不只存得下，還要用得到。圖中的離線節點不再正常提供資料；能承受多少故障，取決於複本、糾刪碼與其他系統條件。* [SVG 原圖](../assets/figures/12-b.svg)
