...
<p align="center"><img src="../assets/figures/02-a.png" width="560" alt="使用者提供問題，貢獻者提出改動，維護角色承擔審查與品質責任，基金會提供制度與公共支援；不同專案的角色名稱和權限會不同。"></p>

*圖 02-1｜同一個專案，不同的責任。這是常見的責任分工示意，不是所有開源專案共用的組織圖。* [SVG 原圖](../assets/figures/02-a.svg)
...
<p align="center"><img src="../assets/figures/02-b.png" width="560" alt="一份修改提案經過審查，可能需要補測試或改設計，獲得接受後才進入共同版本；提出修改不等於自動發布。"></p>

*圖 02-2｜提出修改之後，還要一起判斷。提交、接受與發布是不同階段；實際程序以各專案規則為準。* [SVG 原圖](../assets/figures/02-b.svg)
