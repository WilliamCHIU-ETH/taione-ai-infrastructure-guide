...
<p align="center"><img src="../assets/figures/18-a.png" width="560" alt="從解決可重現問題，到持續照顧共同品質，再到承擔審查與設計責任，技術影響力隨可靠貢獻與信任累積；角色取得仍需各專案認可。"></p>

*圖 18-1｜信任，從持續承擔責任累積。這是能力與責任可能累積的路徑，不是必然升等表。* [SVG 原圖](../assets/figures/18-a.svg)
