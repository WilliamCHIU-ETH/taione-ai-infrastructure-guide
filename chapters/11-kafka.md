...
<p align="center"><img src="../assets/figures/11-a.png" width="560" alt="購買事件寫入 Kafka 後，庫存、推薦與分析系統各自訂閱處理"></p>

*圖 11-1｜一筆事件，多個用途。這是情境示例；Kafka 提供資料流，扣庫存或推薦邏輯仍由應用程式負責。* [SVG 原圖](../assets/figures/11-a.svg)
...
<p align="center"><img src="../assets/figures/11-b.png" width="560" alt="同一份保留中的事件紀錄，兩個消費者可以從不同位置繼續讀取"></p>

*圖 11-2｜讀取進度可以不同。各消費者有自己的讀取進度；能回讀多久，受資料保留設定限制。* [SVG 原圖](../assets/figures/11-b.svg)
