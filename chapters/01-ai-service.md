...
<p align="center"><img src="../assets/figures/01-a.png" width="560" alt="AI 服務的體驗由模型執行、資料與流程、運行資源共同支撐，這些是責任分工，不是每次請求必走的固定路線。"></p>

*圖 01-1｜看見答案背後的共同工作。同一個服務背後有多種責任；實際產品會依需求選擇元件。概念示意。* [SVG 原圖](../assets/figures/01-a.svg)
