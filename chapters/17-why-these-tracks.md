...
<p align="center"><img src="../assets/figures/17-a.png" width="560" alt="理解選題的三種證據：官方目標已公開，技術問題可以查證，逐項取捨與權重尚未查明；三者共同界定可以下的結論。"></p>

*圖 17-1｜選題理由，可以知道到哪裡？有明確的整體意圖，仍不等於知道每項取捨；證據層次要分開。* [SVG 原圖](../assets/figures/17-a.svg)
